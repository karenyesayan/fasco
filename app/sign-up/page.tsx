...
export default function Page() {
  return (
    <main className="flex min-h-screen items-center overflow-hidden bg-white pb-24 lg:pb-0">
      <div className="mx-auto min-h-screen max-w-[120rem] lg:max-h-[67.3125rem] lg:min-h-full min-[137.5rem]:rounded-[0px_30px_30px_0px] min-[137.5rem]:border min-[137.5rem]:border-solid min-[137.5rem]:border-[#DBDBDB]">
        <div className="mx-auto grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 min-[120rem]:gap-x-5.5">
          <div className="max-w-none">
            <Image
              ...
              alt="Confident woman in a red suit with a black crop top, posing against a plain light gray background."
            />
          </div>
